...
public class EventRarityPotionsPatch {
    ...
    public static class PotionsPatchSort {
        ...
        public static void Postfix() {
            ...
            eventPotionList = PotionHelper.getPotionsByRarity(ExileMod.Enums.EVENT);
        }
    }
    ...
    public static class NoEventPotionsFromHelper {
        ...
        public static void Prefix() {
            ...
            tempList.removeIf(str -> (PotionHelper.getPotion(str).rarity != ExileMod.Enums.EVENT));
            PotionHelper.potions.removeIf(str -> (PotionHelper.getPotion(str).rarity == ExileMod.Enums.EVENT));
        }
