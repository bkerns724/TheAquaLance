...
import theArcanist.potions.SteelhidePotion;
...
public class MarketActThree extends AbstractArcanistEvent {
    ...
    static {
        ...
        IMAGE_PATH = ArcanistMod.makeImagePath("events/" + MarketActThree.class.getSimpleName() + ".jpg");
    }
