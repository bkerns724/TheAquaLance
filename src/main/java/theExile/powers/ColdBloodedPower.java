...
public class ColdBloodedPower extends AbstractExilePower {
    public static String POWER_ID = ExileMod.makeID(ColdBloodedPower.class.getSimpleName());

    public ColdBloodedPower(AbstractCreature owner, int amount) {
