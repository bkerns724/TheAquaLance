...
public class FightingPit extends AbstractArcanistEvent {
    ...
    // Health Buff applied in ArcanistMod class
    ...
    static {
        ...
        IMAGE_PATH = ArcanistMod.makeImagePath("events/" + FightingPit.class.getSimpleName() + ".jpg");
    }
