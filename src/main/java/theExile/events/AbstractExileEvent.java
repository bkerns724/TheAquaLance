...
public abstract class AbstractExileEvent extends AbstractImageEvent {
    public String name;
    ...
    public AbstractExileEvent(EventStrings eventStrings, String imagePath, int amount) {
        this(eventStrings, imagePath, amount, -1);
    }

    public AbstractExileEvent(EventStrings eventStrings, String imagePath) {
