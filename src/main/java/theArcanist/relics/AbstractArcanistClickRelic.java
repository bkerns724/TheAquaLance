...
@AutoAdd.Ignore
public abstract class AbstractArcanistClickRelic extends ClickableRelicWithUI {
    public AbstractCard.CardColor color;
    protected int amount;
    protected int amount2;
    protected AbstractCard cardToPreview = null;

    public AbstractArcanistClickRelic(String setId, AbstractRelic.RelicTier tier, AbstractRelic.LandingSound sfx,
                                      AbstractCard.CardColor color, Texture buttonTexture) {
    ...
    public AbstractArcanistClickRelic(String setId, AbstractRelic.RelicTier tier, AbstractRelic.LandingSound sfx,
                                      AbstractCard.CardColor color, String buttonTextureString) {
        super(setId, tier, sfx,
                TexLoader.getTexture(makeRelicPath(setId.replace(modID + ":", "") + ".png")),
                TexLoader.getTexture(buttonTextureString));
        outlineImg = TexLoader.getTexture(makeRelicPath(setId.replace(modID + ":", "") + "_outline.png"));
        this.color = color;
    }
