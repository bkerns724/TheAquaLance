...
public class LadyInRed extends AbstractArcanistEvent {
    ...
    static {
        ...
        IMAGE_PATH = ArcanistMod.makeImagePath("events/" + LadyInRed.class.getSimpleName() + ".jpg");
    }
        ...
        if (!AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
            if (!pickedDebuff) {
                ...
                for (AbstractCard card : AbstractDungeon.gridSelectScreen.selectedCards) {
                    ((AbstractArcanistCard)card).scourgeIncrease = true;
                ...
                if (total % 2 == 0)
                    xOffsetBase += 0.09f;
                for (AbstractCard card : AbstractDungeon.gridSelectScreen.selectedCards) {
                    AbstractArcanistCard arCard = ((AbstractArcanistCard) card);
