...
import static theExile.util.Wiz.replaceLast;
...
public abstract class AbstractExilePower extends AbstractPower {
    ...
    public AbstractExilePower(String id, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        this.ID = id;
        ...
        String textureStringBase = ExileMod.modID + "Resources/images/powers/" +
                ID.replaceAll(ExileMod.modID +":",  "");
